<div class="sidebar-menu">
    <div class="sidebar-header">
        <div class="logo">
            <a href="index.html"><img src="{{  asset('admin-assets/images/icon/logo.png') }}"></a>
        </div>
    </div>
    <div class="main-menu">
            ...
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul class="collapse">
                            <li><a href="index.html">Manage Category</a></li>
                            <li><a href="index3-horizontalmenu.html">Add Category</a></li>
                        </ul>
                    </li>
                    {{-- <li>
